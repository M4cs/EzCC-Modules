...
@implementation PasswordLauncher
- (UIImage *)iconGlyph {
...
- (BOOL)isSelected {
	return self.PasswordLauncher;
}

- (void)setSelected:(BOOL)selected {
  self.PasswordLauncher = selected;
	[super refreshState];
    [self password];
}

- (void)password {
  NSString *bundleID = @"com.agilebits.onepassword-ios";
  [[UIApplication sharedApplication] launchApplicationWithIdentifier:bundleID suspended:FALSE];
		self.PasswordLauncher = NO;
